...
- **To leave a conversation**: swipe right from the left edge of the screen (iOS back gesture) to return to the conversations list. Start the swipe at about x=15
